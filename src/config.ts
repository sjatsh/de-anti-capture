...
import type { Rule, ConfigTarget } from '@shared/types';

// hook 规则 -> spec: call=1;a0=..;a2=..;ret=..   (idle 无 spec)
export function buildSpec(r: Rule): string {
...
export function save(cfgPath: string, targets: ConfigTarget[], opts: { logAll?: boolean }): void {
